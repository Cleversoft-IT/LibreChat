...
class RetrievalFAAPI extends CloudFlareFA {
  constructor(fields) {
    ...
    this.description = `Uno strumento base per interrogare l'API di Zilliz FA. Questa è una classe base che deve essere estesa. Supports automatic image processing for images in responses.`;
